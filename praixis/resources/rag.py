...
class RagResource:
    ...
    def ask(
        ...
        *,
        ...
        raw = self._t.request_json("POST", f"{_PREFIX}/ask", json_body=body, parse="text")
    ...
    def compare(self, collection_name: str, file_1: str, file_2: str) -> dict:
    ...
    def summarize_document(self, collection_name: str, filename: str) -> dict:
